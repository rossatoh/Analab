...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentSection) {
      case Section.ABOUT:
        return (
          <div className="max-w-4xl mx-auto py-16 px-6 text-center">
             <h2 className="font-display text-4xl text-vintage-green mb-8">Desde 2020</h2>
             <p className="font-serif text-lg leading-loose text-vintage-brown-DEFAULT mb-6">
               O Analabvet foi fundado com o princípio de que a medicina veterinária merece a mesma precisão e cuidado da medicina humana. Combinamos técnicas tradicionais de análise com tecnologia de ponta para entregar diagnósticos rápidos e confiáveis.
             </p>
      ...
      case Section.PARTNER_SERVICES:
        return <PartnerServices />;
      case Section.PORTFOLIO:
        // Although removed from nav, keeping component if accessed
        return <ExamsList />;
          ...
          <div className="max-w-3xl mx-auto py-16 px-6">
             <div className="bg-vintage-cream border-2 border-vintage-green p-8 shadow-[8px_8px_0px_rgba(45,90,39,0.2)]">
                <h2 className="font-display text-3xl text-vintage-green mb-6 text-center uppercase border-b-2 border-vintage-green/20 pb-4">
                  Envie seu currículo ou mensagem
                </h2>
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col">
                    <label className="font-serif font-bold text-vintage-brown-DEFAULT mb-1">Assunto</label>
  ...
  const sectionTitles: Partial<Record<Section, string>> = {
    ...
    [Section.PARTNER_SERVICES]: 'Área do Parceiro',
    [Section.PORTFOLIO]: 'Exames e Galeria',
    [Section.CONTACT]: 'Trabalhe Conosco',
  };
        ...
        {currentSection === Section.HOME ? (
          ...
          <div className="bg-vintage-green text-center py-12 relative overflow-hidden">
             ...
             <h1 className="font-display text-4xl text-vintage-cream relative z-10 uppercase tracking-widest text-shadow-plate">
                {sectionTitles[currentSection] || 'Analabvet'}
             </h1>
          </div>
        )}
